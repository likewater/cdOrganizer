...
@rem ##########################################################################
@rem
@rem  tuesdayExercise startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and TUESDAY_EXERCISE_OPTS to pass JVM options to this script.
...
@rem Execute tuesdayExercise
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TUESDAY_EXERCISE_OPTS%  -classpath "%CLASSPATH%" App %CMD_LINE_ARGS%
...
:fail
rem Set variable TUESDAY_EXERCISE_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%TUESDAY_EXERCISE_EXIT_CONSOLE%" exit 1
exit /b 1
